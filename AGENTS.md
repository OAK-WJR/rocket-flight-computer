...
| Block | Current M3-ASSY-R2 | Reference |
|---|---|---|
...
| Actuator power switch (second, high-current battery path) | ✅ Routed in R2 (Q120/Q121 AON6403, gated by the logic path) | `docs/M3_ACTUATOR_MERGE.md` |
| Four servos (3×4 header, 1 k series, pull-downs, SRV05-4 clamp) | ✅ Routed in R2 | Same |
| Dual pyro + complete arming break + continuity sensing | ✅ Routed in R2: two independently fused buses (FMEA H-5), AON7524, per-bus arm sense, cold pull-up (H-1) | Same |
| Pull-pin (launch detect), buzzer | ✅ Routed in R2 | Same |
| Interface to the independent backup altimeter | ✅ Ruled 2026-09-25: none — fully isolated, no shared copper | Same, §1 |
| Mounting holes / zip-tie holes, board length | ✅ 46 × 238 mm; 8 M3 holes kept, 2 zip-tie holes at the servo header. Sled fit not physically verified | Same, §2.5 |
| Manufacturing package (BOM / CPL / Gerber) | ✅ Generated by `tools/export_fab.py`; no quote accepted, nothing ordered | `m3_design/assembly_review/fab/` |
...
python3 tools/export_fab.py                      # Gerber zip + JLC BOM/CPL into m3_design/assembly_review/fab/
